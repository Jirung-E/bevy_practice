...
- 체력이 0일 때 게임을 멈추고 최종 점수·최고 점수·재시작 UI를 표시할 수 있습니다.
- 재시작 시 이전 게임 Entity와 타이머를 정리하고 새 Session을 시작할 수 있습니다.
...
다음 20A부터는 완성된 2D 게임에 시각 효과를 더하기 위한 선택 과정입니다. 먼저 Mesh가 정점 셰이더, rasterization, fragment 셰이더를 거쳐 화면에 그려지는 흐름을 살펴봅니다.
