...
1. 각 챕터의 **학습 목표**, **이 내용으로 만들 수 있는 것**, **이번에 만들 결과물**을 먼저 확인합니다.
...
1. **학습 목표**: 이번 장에서 익힐 능력
2. **이 내용으로 만들 수 있는 것**: 배운 개념이 실제로 쓰이는 구체적인 사례 2~4개
3. **이번에 만들 결과물**: 이 교재에서 직접 실행할 샘플과 실행 방법
4. **핵심 개념**
5. **샘플 코드**
6. **코드 설명**
7. **실습 과제**
...
`이 내용으로 만들 수 있는 것`은 해당 장의 샘플을 다시 설명하는 칸이 아닙니다. 장의 개념을 다른 게임이나 도구에 어떻게 확장할 수 있는지 먼저 보여 주어, 학습 이유를 분명하게 만듭니다.
