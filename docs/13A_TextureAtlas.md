...
- 한 장의 스프라이트 시트로 Idle, Walk, Attack 애니메이션을 재생할 수 있습니다.
- 이동 상태와 바라보는 방향에 따라 서로 다른 프레임 구간을 선택할 수 있습니다.
...
다음 14 챕터에서는 플레이어가 총알을 발사하게 만들고, Entity를 실행 중 생성하는 방법을 배웁니다. 렌더링 파이프라인과 셰이더는 게임을 완성한 뒤 20A부터 다룹니다.
