...
2D에서 다룬 [렌더링 파이프라인과 WGSL 연결](20A_RenderingPipeline.md), [절차적 배경](20B_ProceduralBackground.md), [실전 셰이더 효과](20C_SpaceSurvivorShaderEffects.md), [셰이더 핫 리로드](20D_ShaderHotReload.md)를 먼저 읽으면 셰이더 단계와 바인딩을 더 자세히 복습할 수 있습니다. 이 장에서도 필요한 내용을 다시 설명하므로 Part 2 전체를 먼저 읽을 필요는 없습니다.
