...
- 발사 간격을 제한하고 플레이어 위치에서 진행 방향으로 총알을 생성할 수 있습니다.
- 화면을 벗어나거나 수명이 끝난 투사체를 제거해 Entity 누적을 막을 수 있습니다.
...
과제를 먼저 직접 수행한 뒤 필요할 때 [힌트와 수행 예시](exercises/part2/14_bullets.md)를 확인하세요.
